...
Namespace Propietario
    ...
    Partial Public Class Propietario
        ...
        '''<summary>
        '''Control rfvIdIdPersona.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents rfvIdIdPersona As Global.System.Web.UI.WebControls.RequiredFieldValidator
        ...
        '''<summary>
        '''Control gvPropietario.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents gvPropietario As Global.System.Web.UI.WebControls.GridView
